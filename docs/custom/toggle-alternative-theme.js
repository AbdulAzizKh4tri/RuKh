// COPIED FROM THE DOXYGEN AWESOME REPO

// Toggle zwischen drei Theme-Zuständen und speichere im localStorage
const THEME_CLASSES = ["rukh", "terminal", "theme-default"];
...
globalThis.toggleThemeVariant = toggleThemeVariant;
...
function applyThemeClass(idx) {
	...
	localStorage.setItem(
		"theme-variant",
		THEME_CLASSES[idx] || "theme-default",
	);
