...
/// \todo add conflict field validation. Decide what an empty conflictColumns_ means.
//
/// \todo Figure out a way to know whether it's an update or an insert (Without schema changes, or getting DB specific.).
